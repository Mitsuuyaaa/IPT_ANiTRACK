...
.box {
  ...
  background: #f7fbf7; flex-shrink: 0;
...
.btn-login {
  ...
  box-shadow: 0 4px 14px rgba(67,160,71,0.35); transition: opacity 0.2s, transform 0.15s;
}
...
.right {
  ...
  background: linear-gradient(160deg, #1b3a1f, #2e7d32, #43a047);
...
function validateUsername() {
  ...
  setValid(usernameInput, usernameErr);
  return true;
}
...
function validatePassword() {
  ...
  setValid(passwordInput, passwordErr);
  return true;
}
