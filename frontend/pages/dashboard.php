...
:root {
  ...
  --text-mid:     #4a5e4b;
  --text-light:   #8aaa8b;
  --shadow:       0 4px 24px rgba(27,58,31,0.10);
  --shadow-lg:    0 8px 40px rgba(27,58,31,0.14);
  --radius:       14px;
  --sidebar-w:    240px;
}
...
.sidebar {
  ...
  background: linear-gradient(175deg, var(--green-dark) 0%, var(--green-mid) 55%, var(--green-main) 100%);
...
.avatar {
  ...
  font-size: 14px; font-weight: 700; color: var(--green-dark); flex-shrink: 0;
}
...
.nav-badge { margin-left: auto; background: var(--green-light); color: var(--green-dark); font-size: 9px; font-weight: 700; padding: 2px 7px; border-radius: 10px; }
...
.topbar-date { font-size: 12px; color: var(--text-light); font-weight: 500; }
.notif-btn {
  width: 36px; height: 36px; border-radius: 50%; background: var(--green-surface);
  border: none; cursor: pointer; display: flex; align-items: center; justify-content: center;
  color: var(--green-main); position: relative; transition: background 0.2s;
}
...
/* Welcome Banner */
.welcome-banner {
  background: linear-gradient(120deg, var(--green-dark) 0%, var(--green-mid) 50%, var(--green-main) 100%);
...
.welcome-badge {
  ...
  border-radius: 10px; padding: 10px 20px; text-align: center; z-index: 1; flex-shrink: 0;
}
...
.stat-card::after {
  ...
  border-radius: 50%; top: -20px; right: -20px; opacity: 0.08;
}
...
.tx-item { display: flex; align-items: center; gap: 14px; padding: 12px 14px; border-radius: 10px; background: #fafffe; border: 1px solid #eef6ee; transition: background 0.2s; }
...
.tx-icon.sell   { background: #e8f5e9; color: var(--green-main); }
.tx-icon.buy    { background: #e3f2fd; color: #1e88e5; }
.tx-icon.refund { background: #fff3e0; color: #fb8c00; }
...
.tx-date   { font-size: 11px; color: var(--text-light); margin-top: 1px; }
.tx-amount { font-size: 14px; font-weight: 700; white-space: nowrap; }
.tx-amount.credit { color: var(--green-main); }
...
.action-btn {
  ...
  gap: 8px; padding: 18px 12px; border-radius: 11px;
  background: var(--green-surface); border: 1.5px solid #d0ead0;
...
.progress-header span { font-size: 12px; font-weight: 600; color: var(--text-mid); }
.progress-header .pct { color: var(--green-main); }
.progress-bar { height: 7px; background: #e8f5e9; border-radius: 10px; overflow: hidden; }
.progress-fill { height: 100%; border-radius: 10px; background: linear-gradient(90deg, var(--green-light), var(--green-mid)); transition: width 0.8s ease; }

/* Recent items list */
.item-list { display: flex; flex-direction: column; gap: 10px; }
.item-row { display: flex; align-items: center; gap: 12px; }
.item-dot { width: 8px; height: 8px; border-radius: 50%; flex-shrink: 0; }
.item-dot.green  { background: var(--green-main); }
.item-dot.teal   { background: #00897b; }
.item-dot.orange { background: #fb8c00; }
.item-dot.blue   { background: #1e88e5; }
.item-label { font-size: 12px; color: var(--text-mid); flex: 1; }
.item-val   { font-size: 13px; font-weight: 600; color: var(--text-dark); }
...
<aside class="sidebar">
  <div class="sidebar-logo">
    ANI<span>TRACK</span>
    <small>FARM SALES TRACKER</small>
  </div>
  ...
  <div class="content">
    ...
    <div class="welcome-banner">
      <div class="welcome-text">
        ...
        <p>Here's a summary of your ANI-TRACK activity today.</p>
      </div>
    ...
    <div class="two-col">
      ...
      <div class="panel">
        ...
        <div class="panel-body">
          <div class="tx-list">
            <div style="text-align:center; padding: 30px 0; color: var(--text-light); font-size: 13px;">
              <svg style="width:40px;height:40px;margin-bottom:10px;opacity:0.3;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
              <p>No transactions yet.</p>
              <p style="font-size:11px;margin-top:4px;">Start recording your sales to see them here.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style="display:flex;flex-direction:column;gap:18px;">
        ...
        <div class="profile-card">
          ...
          <div class="profile-avatar-wrap">
            <div class="profile-avatar-big"><?php echo strtoupper(substr($userData['first_name'], 0, 1) . substr($userData['last_name'], 0, 1)); ?></div>
          </div>
          <div class="profile-info">
            ...
            <div class="profile-detail">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2.22h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6.15 6.15l.91-.91a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.73 17.46a2 2 0 0 1-.81-.54z"/></svg>
    ...
    <div class="bottom-row">
      ...
      <!-- Sales Goals -->
      <div class="panel">
        <div class="panel-header"><h3>Monthly Goals</h3><button>Edit Goals</button></div>
        <div class="panel-body">
          <div class="progress-list">
            <div class="progress-item">
              <div class="progress-header"><span>Sales Target</span><span class="pct">0%</span></div>
              <div class="progress-bar"><div class="progress-fill" style="width:0%"></div></div>
            </div>
            <div class="progress-item">
              <div class="progress-header"><span>New Customers</span><span class="pct">0%</span></div>
              <div class="progress-bar"><div class="progress-fill" style="width:0%"></div></div>
            </div>
            <div class="progress-item">
              <div class="progress-header"><span>Products Listed</span><span class="pct">0%</span></div>
              <div class="progress-bar"><div class="progress-fill" style="width:0%"></div></div>
            </div>
            <div class="progress-item">
              <div class="progress-header"><span>Transactions</span><span class="pct">0%</span></div>
              <div class="progress-bar"><div class="progress-fill" style="width:0%"></div></div>
            </div>
          </div>
        </div>
      ...
      <div class="panel">
        <div class="panel-header"><h3>Top Products</h3><a href="#">View all</a></div>
        <div class="panel-body">
          <div style="text-align:center; padding: 30px 0; color: var(--text-light); font-size: 13px;">
            <svg style="width:40px;height:40px;margin-bottom:10px;opacity:0.3;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>
            <p>No products added yet.</p>
            <p style="font-size:11px;margin-top:4px;">Add products to your inventory to track sales.</p>
          </div>
        </div>
      </div>
